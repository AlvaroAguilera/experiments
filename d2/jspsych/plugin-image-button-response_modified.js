  ...
  class ImageButtonResponsePlugin {
    ...
    trial(display_element, trial) {
      ...
      function after_response(choice) {
        ...
        response.rt.push(rt);
        if (buttonGroupElement.children[choice].getAttribute("data-active") === "true") {
          buttonGroupElement.children[choice].setAttribute("data-active", "false");
          buttonGroupElement.children[choice].style.backgroundColor = "";
          buttonGroupElement.children[choice].style.color = "";
        } else {
          buttonGroupElement.children[choice].setAttribute("data-active", "true");
          buttonGroupElement.children[choice].style.backgroundColor = "#016bbb";
          buttonGroupElement.children[choice].style.color = "#333";
        };
